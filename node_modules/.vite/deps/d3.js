...
function EnterNode(parent, datum5) {
...
function merge_default(context) {
  ...
  for (var groups0 = this._groups, groups1 = selection5._groups, m0 = groups0.length, m1 = groups1.length, m3 = Math.min(m0, m1), merges = new Array(m0), j = 0; j < m3; ++j) {
...
function nodrag_default(view) {
  var root6 = view.document.documentElement, selection5 = select_default2(view).on("dragstart.drag", noevent_default, nonpassivecapture);
...
function yesdrag(view, noclick) {
  var root6 = view.document.documentElement, selection5 = select_default2(view).on("dragstart.drag", null);
  if (noclick) {
...
function drag_default() {
  var filter8 = defaultFilter, container = defaultContainer, subject = defaultSubject, touchable = defaultTouchable, gestures = {}, listeners = dispatch_default("start", "drag", "end"), active = 0, mousedownx, mousedowny, mousemoving, touchending, clickDistance2 = 0;
  ...
  function mousedowned(event, d) {
    if (touchending || !filter8.call(this, event, d))
      return;
  ...
  drag.filter = function(_) {
    return arguments.length ? (filter8 = typeof _ === "function" ? _ : constant_default2(!!_), drag) : filter8;
  };
...
function EnterNode2(parent, datum5) {
  this.ownerDocument = parent.ownerDocument;
  this.namespaceURI = parent.namespaceURI;
  this._next = null;
  this._parent = parent;
...
function arrayAll3(select) {
  return function() {
    var group4 = select.apply(this, arguments);
    return group4 == null ? [] : array_default2(group4);
  };
}
...
function EnterNode3(parent, datum5) {
  this.ownerDocument = parent.ownerDocument;
  this.namespaceURI = parent.namespaceURI;
  this._next = null;
  this._parent = parent;
...
function data_default3(value, key) {
  ...
  for (var m3 = groups4.length, update = new Array(m3), enter = new Array(m3), exit = new Array(m3), j = 0; j < m3; ++j) {
    var parent = parents[j], group4 = groups4[j], groupLength = group4.length, data = array_default2(value.call(parent, parent && parent.__data__, j, parents)), dataLength = data.length, enterGroup = enter[j] = new Array(dataLength), updateGroup = update[j] = new Array(dataLength), exitGroup = exit[j] = new Array(groupLength);
    bind(parent, group4, enterGroup, updateGroup, exitGroup, data, key);
    for (var i0 = 0, i1 = 0, previous, next; i0 < dataLength; ++i0) {
      if (previous = enterGroup[i0]) {
        if (i0 >= i1)
...
function merge_default3(selection5) {
  if (!(selection5 instanceof Selection3))
...
function insert_default3(name, before) {
  var create2 = typeof name === "function" ? name : creator_default3(name), select = before == null ? constantNull3 : typeof before === "function" ? before : selector_default3(before);
  return this.select(function() {
    return this.insertBefore(create2.apply(this, arguments), select.apply(this, arguments) || null);
  });
}
...
function selectAll_default7(select) {
  ...
  for (var groups4 = this._groups, m3 = groups4.length, subgroups = [], parents = [], j = 0; j < m3; ++j) {
    for (var group4 = groups4[j], n = group4.length, node, i = 0; i < n; ++i) {
      if (node = group4[i]) {
        for (var children5 = select.call(node, node.__data__, i, group4), child, inherit2 = get2(node, id2), k2 = 0, l = children5.length; k2 < l; ++k2) {
...
function styleMaybeRemove(id2, name) {
  var on0, on1, listener0, key = "style." + name, event = "end." + key, remove5;
  return function() {
    var schedule = set3(this, id2), on = schedule.on, listener = schedule.value[key] == null ? remove5 || (remove5 = styleRemove4(name)) : void 0;
  ...
  if (schedules) {
    ...
    for (i in schedules) {
      if ((schedule = schedules[i]).state > SCHEDULED && schedule.name === name) {
        return new Transition([[node]], root4, name, +i);
      }
    }
  }
  return null;
...
function BrushEvent(type2, {
  ...
  Object.defineProperties(this, {
    ...
    sourceEvent: { value: sourceEvent, enumerable: true, configurable: true },
    target: { value: target, enumerable: true, configurable: true },
    selection: { value: selection5, enumerable: true, configurable: true },
...
function brush(dim) {
  var extent3 = defaultExtent, filter8 = defaultFilter2, touchable = defaultTouchable2, keys = true, listeners = dispatch_default("start", "brush", "end"), handleSize = 6, touchending;
  function brush2(group4) {
    ...
    overlay.enter().append("rect").attr("class", "overlay").attr("pointer-events", "all").attr("cursor", cursors.overlay).merge(overlay).each(function() {
      var extent4 = local4(this).extent;
      select_default4(this).attr("x", extent4[0][0]).attr("y", extent4[0][1]).attr("width", extent4[1][0] - extent4[0][0]).attr("height", extent4[1][1] - extent4[0][1]);
    });
  ...
  brush2.move = function(group4, selection5, event) {
    if (group4.tween) {
      group4.on("start.brush", function(event2) {
        ...
        var that = this, state = that.__brush, emit = emitter(that, arguments), selection0 = state.selection, selection1 = dim.input(typeof selection5 === "function" ? selection5.apply(this, arguments) : selection5, state.extent), i = value_default(selection0, selection1);
        function tween(t) {
  ...
  function redraw() {
    var group4 = select_default4(this), selection5 = local4(this).selection;
    if (selection5) {
      group4.selectAll(".selection").style("display", null).attr("x", selection5[0][0]).attr("y", selection5[0][1]).attr("width", selection5[1][0] - selection5[0][0]).attr("height", selection5[1][1] - selection5[0][1]);
  ...
  function started(event) {
    ...
    if (!filter8.apply(this, arguments))
      return;
    var that = this, type2 = event.target.__data__.type, mode3 = (keys && event.metaKey ? type2 = "overlay" : type2) === "selection" ? MODE_DRAG : keys && event.altKey ? MODE_CENTER : MODE_HANDLE, signX = dim === Y ? null : signsX[type2], signY = dim === X ? null : signsY[type2], state = local4(that), extent4 = state.extent, selection5 = state.selection, W = extent4[0][0], w0, w1, N = extent4[0][1], n0, n1, E2 = extent4[1][0], e0, e1, S = extent4[1][1], s0, s1, dx = 0, dy = 0, moving, shifting = signX && signY && keys && event.shiftKey, lockX, lockY, points = Array.from(event.touches || [event], (t) => {
    ...
    e1 = e0;
    s1 = s0;
    var group4 = select_default4(that).attr("pointer-events", "none");
  ...
  brush2.extent = function(_) {
    return arguments.length ? (extent3 = typeof _ === "function" ? _ : constant_default6(number22(_)), brush2) : extent3;
  };
  brush2.filter = function(_) {
    return arguments.length ? (filter8 = typeof _ === "function" ? _ : constant_default6(!!_), brush2) : filter8;
  };
...
function bisector2(f) {
  ...
  if (f.length !== 2) {
    ...
    compare1 = f === ascending5 || f === descending2 ? f : zero3;
    compare2 = f;
    delta = f;
  }
  function left2(a4, x4, lo = 0, hi = a4.length) {
...
var ascendingBisect2 = bisector2(ascending5);
...
function text_default5(input, init2) {
...
function dsvParse(parse) {
  return function(input, init2, row) {
    ...
    return text_default5(input, init2).then(function(response) {
...
function parser(type2) {
  return (input, init2) => text_default5(input, init2).then((text) => new DOMParser().parseFromString(text, type2));
}
...
function link_default(links) {
  var id2 = index3, strength = defaultStrength, strengths, distance = constant_default9(30), distances, nodes, count5, bias, random, iterations2 = 1;
  if (links == null)
    links = [];
  ...
  function initialize() {
    ...
    for (i = 0, count5 = new Array(n); i < m3; ++i) {
      ...
      if (typeof link3.source !== "object")
        link3.source = find4(nodeById, link3.source);
      if (typeof link3.target !== "object")
        link3.target = find4(nodeById, link3.target);
...
function ticks_default(start2, stop, count5) {
  var reverse4, i = -1, n, ticks3, step;
  stop = +stop, start2 = +start2, count5 = +count5;
  if (start2 === stop && count5 > 0)
    return [start2];
  if (reverse4 = stop < start2)
    n = start2, start2 = stop, stop = n;
  if ((step = tickIncrement3(start2, stop, count5)) === 0 || !isFinite(step))
    return [];
  if (step > 0) {
...
function quickselect3(array8, k2, left2 = 0, right2 = array8.length - 1, compare = ascending_default2) {
  while (right2 > left2) {
    if (right2 - left2 > 600) {
      const n = right2 - left2 + 1;
      const m3 = k2 - left2 + 1;
      ...
      const newLeft = Math.max(left2, Math.floor(k2 - m3 * s2 / n + sd));
      const newRight = Math.min(right2, Math.floor(k2 + (n - m3) * s2 / n + sd));
      quickselect3(array8, k2, newLeft, newRight, compare);
    }
    const t = array8[k2];
    let i = left2;
    let j = right2;
    swap3(array8, left2, k2);
    if (compare(array8[right2], t) > 0)
      swap3(array8, left2, right2);
    while (i < j) {
      swap3(array8, i, j), ++i, --j;
      while (compare(array8[i], t) < 0)
        ++i;
      while (compare(array8[j], t) > 0)
        --j;
    ...
    if (compare(array8[left2], t) === 0)
      swap3(array8, left2, j);
    else
      ++j, swap3(array8, j, right2);
    if (j <= k2)
      left2 = j + 1;
    if (k2 <= j)
      right2 = j - 1;
...
function quantileSorted3(values, p, valueof = number_default2) {
  if (!(n = values.length))
    return;
  if ((p = +p) <= 0 || n < 2)
    return +valueof(values[0], 0, values);
...
function cluster_default() {
  ...
  function cluster(root6) {
    var previousNode, x4 = 0;
    root6.eachAfter(function(node) {
    ...
    var left2 = leafLeft(root6), right2 = leafRight(root6), x06 = left2.x - separation(left2, right2) / 2, x12 = right2.x + separation(right2, left2) / 2;
    return root6.eachAfter(nodeSize ? function(node) {
      node.x = (node.x - root6.x) * dx;
      node.y = (root6.y - node.y) * dy;
    } : function(node) {
      node.x = (node.x - x06) / (x12 - x06) * dx;
      node.y = (1 - (root6.y ? node.y / root6.y : 1)) * dy;
    });
  }
...
function eachBefore_default(callback, that) {
  var node = this, nodes = [node], children5, i, index5 = -1;
  while (node = nodes.pop()) {
    callback.call(that, node, ++index5, this);
...
function eachAfter_default(callback, that) {
  var node = this, nodes = [node], next = [], children5, i, n, index5 = -1;
  while (node = nodes.pop()) {
    next.push(node);
    if (children5 = node.children) {
...
function sum_default(value) {
  return this.eachAfter(function(node) {
    var sum6 = +value(node.data) || 0, children5 = node.children, i = children5 && children5.length;
    while (--i >= 0)
      sum6 += children5[i].value;
    node.value = sum6;
  });
...
function links_default() {
  var root6 = this, links = [];
  root6.each(function(node) {
    if (node !== root6) {
...
function* iterator_default4() {
  var node = this, current, next = [node], children5, i, n;
  do {
...
function hierarchy(data, children5) {
  ...
  var root6 = new Node(data), node, nodes = [root6], child, childs, i, n;
  while (node = nodes.pop()) {
...
function pack_default() {
  ...
  function pack(root6) {
    ...
    root6.x = dx / 2, root6.y = dy / 2;
    if (radius) {
      root6.eachBefore(radiusLeaf(radius)).eachAfter(packChildrenRandom(padding, 0.5, random)).eachBefore(translateChild(1));
    } else {
      root6.eachBefore(radiusLeaf(defaultRadius2)).eachAfter(packChildrenRandom(constantZero, 1, random)).eachAfter(packChildrenRandom(padding, root6.r / Math.min(dx, dy), random)).eachBefore(translateChild(Math.min(dx, dy) / (2 * root6.r)));
    }
    return root6;
  }
...
function packChildrenRandom(padding, k2, random) {
  return function(node) {
    if (children5 = node.children) {
      var children5, i, n = children5.length, r = padding(node) * k2 || 0, e;
      if (r)
        for (i = 0; i < n; ++i)
          children5[i].r += r;
      e = packSiblingsRandom(children5, random);
      if (r)
        for (i = 0; i < n; ++i)
          children5[i].r -= r;
      node.r = e + r;
...
function partition_default() {
  ...
  function partition(root6) {
    var n = root6.height + 1;
    root6.x0 = root6.y0 = padding;
    root6.x1 = dx;
    root6.y1 = dy / n;
    root6.eachBefore(positionNode(dy, n));
    if (round)
      root6.eachBefore(round_default2);
    return root6;
  }
...
function stratify_default() {
  ...
  function stratify(data) {
    var nodes = Array.from(data), currentId = id2, currentParentId = parentId, n, d, i, root6, parent, node, nodeId, nodeKey, nodeByKey = /* @__PURE__ */ new Map();
    if (path3 != null) {
    ...
    if (path3 != null) {
      while (root6.data === imputed && root6.children.length === 1) {
        root6 = root6.children[0], --n;
      }
    ...
    root6.parent = preroot;
    root6.eachBefore(function(node2) {
...
function nextLeft(v2) {
  var children5 = v2.children;
  return children5 ? children5[0] : v2.t;
}
function nextRight(v2) {
  var children5 = v2.children;
  return children5 ? children5[children5.length - 1] : v2.t;
}
...
function executeShifts(v2) {
  var shift = 0, change = 0, children5 = v2.children, i = children5.length, w;
  while (--i >= 0) {
    w = children5[i];
    w.z += shift;
    w.m += shift;
...
function treeRoot(root6) {
  var tree = new TreeNode(root6, 0), node, nodes = [tree], child, children5, i, n;
  while (node = nodes.pop()) {
...
function tree_default() {
  ...
  function tree(root6) {
    var t = treeRoot(root6);
    t.eachAfter(firstWalk), t.parent.m = -t.z;
    t.eachBefore(secondWalk);
    if (nodeSize)
      root6.eachBefore(sizeNode);
    else {
      var left2 = root6, right2 = root6, bottom2 = root6;
      root6.eachBefore(function(node) {
        if (node.x < left2.x)
          left2 = node;
        if (node.x > right2.x)
          right2 = node;
  ...
  function firstWalk(v2) {
    var children5 = v2.children, siblings = v2.parent.children, w = v2.i ? siblings[v2.i - 1] : null;
    if (children5) {
      executeShifts(v2);
...
function treemap_default() {
  ...
  function treemap(root6) {
    root6.x0 = root6.y0 = 0;
    root6.x1 = dx;
    root6.y1 = dy;
    root6.eachBefore(positionNode);
    paddingStack = [0];
    if (round)
      root6.eachBefore(round_default2);
    return root6;
...
function locale_default2(locale4) {
  var group4 = locale4.grouping === void 0 || locale4.thousands === void 0 ? identity_default6 : formatGroup_default2(map8.call(locale4.grouping, Number), locale4.thousands + ""), currencyPrefix = locale4.currency === void 0 ? "" : locale4.currency[0] + "", currencySuffix = locale4.currency === void 0 ? "" : locale4.currency[1] + "", decimal = locale4.decimal === void 0 ? "." : locale4.decimal + "", numerals = locale4.numerals === void 0 ? identity_default6 : formatNumerals_default2(map8.call(locale4.numerals, String)), percent = locale4.percent === void 0 ? "%" : locale4.percent + "", minus = locale4.minus === void 0 ? "−" : locale4.minus + "", nan = locale4.nan === void 0 ? "NaN" : locale4.nan + "";
  function newFormat(specifier) {
...
function quantile4() {
  ...
  function scale2(x4) {
    return x4 == null || isNaN(x4 = +x4) ? unknown : range5[bisect_default3(thresholds, x4)];
  }
...
function quantize() {
  ...
  function scale2(x4) {
    return x4 != null && x4 <= x4 ? range5[bisect_default3(domain, x4, 0, n)] : unknown;
  }
  function rescale() {
    var i = -1;
    domain = new Array(n);
...
function ticker(year2, month2, week, day2, hour2, minute2) {
  ...
  function tickInterval(start2, stop, count5) {
    ...
    if (i === 0)
      return millisecond_default.every(Math.max(tickStep3(start2, stop, count5), 1));
...
function calendar(ticks3, tickInterval, year2, month2, week, day2, hour2, minute2, second3, format3) {
  ...
  scale2.copy = function() {
    return copy(scale2, calendar(ticks3, tickInterval, year2, month2, week, day2, hour2, minute2, second3, format3));
  };
  return scale2;
}
function time() {
...
function transformer3() {
  var x06 = 0, x12 = 1, t04, t14, k10, transform2, interpolator = identity4, clamp = false, unknown;
  function scale2(x4) {
...
function transformer4() {
  var x06 = 0, x12 = 0.5, x22 = 1, s2 = 1, t04, t14, t22, k10, k21, interpolator = identity4, transform2, clamp = false, unknown;
  function scale2(x4) {
...
function selectorAll_default4(selector) {
  return selector == null ? empty6 : function() {
    return this.querySelectorAll(selector);
  };
}
...
function childrenFilter4(match) {
  return function() {
    return filter7.call(this.children, match);
  };
}
...
function EnterNode4(parent, datum5) {
  this.ownerDocument = parent.ownerDocument;
  this.namespaceURI = parent.namespaceURI;
  this._next = null;
  this._parent = parent;
...
function bindIndex4(parent, group4, enter, update, exit, data) {
  var i = 0, node, groupLength = group4.length, dataLength = data.length;
  for (; i < dataLength; ++i) {
    if (node = group4[i]) {
      node.__data__ = data[i];
...
function bindKey4(parent, group4, enter, update, exit, data, key) {
  var i, node, nodeByKeyValue = /* @__PURE__ */ new Map(), groupLength = group4.length, dataLength = data.length, keyValues = new Array(groupLength), keyValue;
  for (i = 0; i < groupLength; ++i) {
    if (node = group4[i]) {
      keyValues[i] = keyValue = key.call(node, node.__data__, i, group4) + "";
...
function data_default5(value, key) {
  if (!arguments.length)
    return Array.from(this, datum4);
  var bind = key ? bindKey4 : bindIndex4, parents = this._parents, groups4 = this._groups;
  if (typeof value !== "function")
...
function property_default4(name, value) {
...
function classedAdd4(node, names) {
  var list = classList4(node), i = -1, n = names.length;
  while (++i < n)
    list.add(names[i]);
}
function classedRemove4(node, names) {
  var list = classList4(node), i = -1, n = names.length;
  while (++i < n)
    list.remove(names[i]);
}
...
function append_default4(name) {
  var create2 = typeof name === "function" ? name : creator_default4(name);
  return this.select(function() {
    return this.appendChild(create2.apply(this, arguments));
  });
}
...
function insert_default4(name, before) {
  var create2 = typeof name === "function" ? name : creator_default4(name), select = before == null ? constantNull4 : typeof before === "function" ? before : selector_default4(before);
  return this.select(function() {
    return this.insertBefore(create2.apply(this, arguments), select.apply(this, arguments) || null);
  });
}
...
function onAdd4(typename, value, options) {
  return function() {
    var on = this.__on, o, listener = contextListener4(value);
    if (on)
      for (var j = 0, m3 = on.length; j < m3; ++j) {
        if ((o = on[j]).type === typename.type && o.name === typename.name) {
          this.removeEventListener(o.type, o.listener, o.options);
...
function dispatchEvent4(node, type2, params) {
...
function dispatchConstant4(type2, params) {
  return function() {
    return dispatchEvent4(this, type2, params);
  };
}
function dispatchFunction4(type2, params) {
  return function() {
    return dispatchEvent4(this, type2, params.apply(this, arguments));
  };
}
function dispatch_default5(type2, params) {
  return this.each((typeof params === "function" ? dispatchFunction4 : dispatchConstant4)(type2, params));
}

// node_modules/d3/node_modules/d3-selection/src/selection/iterator.js
function* iterator_default5() {
  for (var groups4 = this._groups, j = 0, m3 = groups4.length; j < m3; ++j) {
    for (var group4 = groups4[j], i = 0, n = group4.length, node; i < n; ++i) {
      if (node = group4[i])
        yield node;
...
Selection5.prototype = selection4.prototype = {
  ...
  [Symbol.iterator]: iterator_default5
};
var selection_default5 = selection4;
...
function create_default4(name) {
  return select_default9(creator_default4(name).call(document.documentElement));
}
...
Local4.prototype = local5.prototype = {
  constructor: Local4,
  get: function(node) {
    var id2 = this._;
    while (!(id2 in node))
...
function pointers_default4(events, node) {
  if (events.target) {
    events = sourceEvent_default4(events);
    if (node === void 0)
...
function selectAll_default9(selector) {
  return typeof selector === "string" ? new Selection5([document.querySelectorAll(selector)], [document.documentElement]) : new Selection5([array7(selector)], root5);
}

// node_modules/d3/node_modules/d3-shape/src/constant.js
function constant_default14(x4) {
...
function arc_default() {
  var innerRadius = arcInnerRadius, outerRadius = arcOuterRadius, cornerRadius = constant_default14(0), padRadius = null, startAngle = arcStartAngle, endAngle = arcEndAngle, padAngle = arcPadAngle, context = null, path3 = withPath(arc);
  function arc() {
    ...
    if (!(r1 > epsilon9))
      ...
      var a01 = a0, a11 = a1, a00 = a0, a10 = a1, da0 = da2, da1 = da2, ap = padAngle.apply(this, arguments) / 2, rp = ap > epsilon9 && (padRadius ? +padRadius.apply(this, arguments) : sqrt3(r0 * r0 + r1 * r1)), rc = min5(abs4(r1 - r0) / 2, +cornerRadius.apply(this, arguments)), rc0 = rc, rc1 = rc, t04, t14;
      if (rp > epsilon9) {
  ...
  arc.innerRadius = function(_) {
    return arguments.length ? (innerRadius = typeof _ === "function" ? _ : constant_default14(+_), arc) : innerRadius;
  };
  arc.outerRadius = function(_) {
    return arguments.length ? (outerRadius = typeof _ === "function" ? _ : constant_default14(+_), arc) : outerRadius;
  };
  arc.cornerRadius = function(_) {
    return arguments.length ? (cornerRadius = typeof _ === "function" ? _ : constant_default14(+_), arc) : cornerRadius;
  };
  arc.padRadius = function(_) {
    return arguments.length ? (padRadius = _ == null ? null : typeof _ === "function" ? _ : constant_default14(+_), arc) : padRadius;
  };
  arc.startAngle = function(_) {
    return arguments.length ? (startAngle = typeof _ === "function" ? _ : constant_default14(+_), arc) : startAngle;
  };
  arc.endAngle = function(_) {
    return arguments.length ? (endAngle = typeof _ === "function" ? _ : constant_default14(+_), arc) : endAngle;
  };
  arc.padAngle = function(_) {
    return arguments.length ? (padAngle = typeof _ === "function" ? _ : constant_default14(+_), arc) : padAngle;
  };
...
function line_default2(x4, y4) {
  var defined = constant_default14(true), context = null, curve = linear_default, output = null, path3 = withPath(line);
  x4 = typeof x4 === "function" ? x4 : x4 === void 0 ? x3 : constant_default14(x4);
  y4 = typeof y4 === "function" ? y4 : y4 === void 0 ? y3 : constant_default14(y4);
  function line(data) {
  ...
  line.x = function(_) {
    return arguments.length ? (x4 = typeof _ === "function" ? _ : constant_default14(+_), line) : x4;
  };
  line.y = function(_) {
    return arguments.length ? (y4 = typeof _ === "function" ? _ : constant_default14(+_), line) : y4;
  };
  line.defined = function(_) {
    return arguments.length ? (defined = typeof _ === "function" ? _ : constant_default14(!!_), line) : defined;
  };
...
function area_default5(x06, y06, y12) {
  var x12 = null, defined = constant_default14(true), context = null, curve = linear_default, output = null, path3 = withPath(area);
  x06 = typeof x06 === "function" ? x06 : x06 === void 0 ? x3 : constant_default14(+x06);
  y06 = typeof y06 === "function" ? y06 : y06 === void 0 ? constant_default14(0) : constant_default14(+y06);
  y12 = typeof y12 === "function" ? y12 : y12 === void 0 ? y3 : constant_default14(+y12);
  function area(data) {
  ...
  area.x = function(_) {
    return arguments.length ? (x06 = typeof _ === "function" ? _ : constant_default14(+_), x12 = null, area) : x06;
  };
  area.x0 = function(_) {
    return arguments.length ? (x06 = typeof _ === "function" ? _ : constant_default14(+_), area) : x06;
  };
  area.x1 = function(_) {
    return arguments.length ? (x12 = _ == null ? null : typeof _ === "function" ? _ : constant_default14(+_), area) : x12;
  };
  area.y = function(_) {
    return arguments.length ? (y06 = typeof _ === "function" ? _ : constant_default14(+_), y12 = null, area) : y06;
  };
  area.y0 = function(_) {
    return arguments.length ? (y06 = typeof _ === "function" ? _ : constant_default14(+_), area) : y06;
  };
  area.y1 = function(_) {
    return arguments.length ? (y12 = _ == null ? null : typeof _ === "function" ? _ : constant_default14(+_), area) : y12;
  };
  ...
  area.defined = function(_) {
    return arguments.length ? (defined = typeof _ === "function" ? _ : constant_default14(!!_), area) : defined;
  };
...
function pie_default() {
  var value = identity_default7, sortValues = descending_default2, sort4 = null, startAngle = constant_default14(0), endAngle = constant_default14(tau7), padAngle = constant_default14(0);
  function pie(data) {
    var i, n = (data = array_default4(data)).length, j, k2, sum6 = 0, index5 = new Array(n), arcs = new Array(n), a0 = +startAngle.apply(this, arguments), da2 = Math.min(tau7, Math.max(-tau7, endAngle.apply(this, arguments) - a0)), a1, p = Math.min(Math.abs(da2) / n, padAngle.apply(this, arguments)), pa = p * (da2 < 0 ? -1 : 1), v2;
    for (i = 0; i < n; ++i) {
  ...
  pie.value = function(_) {
    return arguments.length ? (value = typeof _ === "function" ? _ : constant_default14(+_), pie) : value;
  };
  ...
  pie.startAngle = function(_) {
    return arguments.length ? (startAngle = typeof _ === "function" ? _ : constant_default14(+_), pie) : startAngle;
  };
  pie.endAngle = function(_) {
    return arguments.length ? (endAngle = typeof _ === "function" ? _ : constant_default14(+_), pie) : endAngle;
  };
  pie.padAngle = function(_) {
    return arguments.length ? (padAngle = typeof _ === "function" ? _ : constant_default14(+_), pie) : padAngle;
  };
  return pie;
}
...
function link2(curve) {
  ...
  link3.x = function(_) {
    return arguments.length ? (x4 = typeof _ === "function" ? _ : constant_default14(+_), link3) : x4;
  };
  link3.y = function(_) {
    return arguments.length ? (y4 = typeof _ === "function" ? _ : constant_default14(+_), link3) : y4;
  };
...
function Symbol2(type2, size) {
  ...
  type2 = typeof type2 === "function" ? type2 : constant_default14(type2 || circle_default3);
  size = typeof size === "function" ? size : constant_default14(size === void 0 ? 64 : +size);
  function symbol() {
    let buffer;
    if (!context)
      context = buffer = path3();
  ...
  symbol.type = function(_) {
    return arguments.length ? (type2 = typeof _ === "function" ? _ : constant_default14(_), symbol) : type2;
  };
  symbol.size = function(_) {
    return arguments.length ? (size = typeof _ === "function" ? _ : constant_default14(+_), symbol) : size;
  };
...
function stack_default() {
  var keys = constant_default14([]), order = none_default2, offset = none_default, value = stackValue;
  function stack(data) {
  ...
  stack.keys = function(_) {
    return arguments.length ? (keys = typeof _ === "function" ? _ : constant_default14(Array.from(_)), stack) : keys;
  };
  stack.value = function(_) {
    return arguments.length ? (value = typeof _ === "function" ? _ : constant_default14(+_), stack) : value;
  };
  stack.order = function(_) {
    return arguments.length ? (order = _ == null ? none_default2 : typeof _ === "function" ? _ : constant_default14(Array.from(_)), stack) : order;
  };
...
function ticker2(year2, month2, week, day2, hour2, minute2) {
  ...
  function tickInterval(start2, stop, count5) {
    ...
    if (i === 0)
      return millisecond2.every(Math.max(tickStep(start2, stop, count5), 1));
    const [t, step] = tickIntervals[target / tickIntervals[i - 1][2] < tickIntervals[i][2] / target ? i - 1 : i];
    return t.every(step);
  }
  return [ticks3, tickInterval];
...
function zoom_default2() {
  ...
  zoom.scaleBy = function(selection5, k2, p, event) {
    zoom.scaleTo(selection5, function() {
      var k0 = this.__zoom.k, k1 = typeof k2 === "function" ? k2.apply(this, arguments) : k2;
      return k0 * k1;
    }, p, event);
  };
  zoom.scaleTo = function(selection5, k2, p, event) {
    zoom.transform(selection5, function() {
      var e = extent3.apply(this, arguments), t04 = this.__zoom, p02 = p == null ? centroid(e) : typeof p === "function" ? p.apply(this, arguments) : p, p1 = t04.invert(p02), k1 = typeof k2 === "function" ? k2.apply(this, arguments) : k2;
      return constrain(translate(scale2(t04, k1), p02, p1), e, translateExtent);
    }, p, event);
  };
  zoom.translateBy = function(selection5, x4, y4, event) {
    zoom.transform(selection5, function() {
  ...
  zoom.translateTo = function(selection5, x4, y4, p, event) {
    zoom.transform(selection5, function() {
  ...
  Gesture.prototype = {
    ...
    emit: function(type2) {
      var d = select_default6(this.that).datum();
      listeners.call(
        type2,
        this.that,
        new ZoomEvent(type2, {
  ...
  function mousedowned(event, ...args) {
    if (touchending || !filter8.apply(this, arguments))
      return;
    var currentTarget = event.currentTarget, g = gesture(this, args, true).event(event), v2 = select_default6(event.view).on("mousemove.zoom", mousemoved, true).on("mouseup.zoom", mouseupped, true), p = pointer_default3(event, currentTarget), x06 = event.clientX, y06 = event.clientY;
    nodrag_default(event.view);
  ...
  function dblclicked(event, ...args) {
    if (!filter8.apply(this, arguments))
      return;
    var t04 = this.__zoom, p02 = pointer_default3(event.changedTouches ? event.changedTouches[0] : event, this), p1 = t04.invert(p02), k1 = t04.k * (event.shiftKey ? 0.5 : 2), t14 = constrain(translate(scale2(t04, k1), p02, p1), extent3.apply(this, args), translateExtent);
    noevent_default3(event);
    if (duration > 0)
      select_default6(this).transition().duration(duration).call(schedule, t14, p02, event);
    else
      select_default6(this).call(zoom.transform, t14, p02, event);
  }
    ...
    if (g.touch0)
      ...
      if (g.taps === 2) {
        ...
        if (Math.hypot(touchfirst[0] - t[0], touchfirst[1] - t[1]) < tapDistance) {
          var p = select_default6(this).on("dblclick.zoom");
          if (p)
  ...
  zoom.filter = function(_) {
    return arguments.length ? (filter8 = typeof _ === "function" ? _ : constant_default15(!!_), zoom) : filter8;
  };
  zoom.touchable = function(_) {
    return arguments.length ? (touchable = typeof _ === "function" ? _ : constant_default15(!!_), zoom) : touchable;
  };
  zoom.extent = function(_) {
    return arguments.length ? (extent3 = typeof _ === "function" ? _ : constant_default15([[+_[0][0], +_[0][1]], [+_[1][0], +_[1][1]]]), zoom) : extent3;
  };
...
export {
  ...
  count,
  create_default4 as create,
  creator_default4 as creator,
  cross,
  csv2 as csv,
  csvFormat,
  csvFormatBody,
  ...
  namespaces_default4 as namespaces,
  nice,
  now,
  ...
  select_default9 as select,
  selectAll_default9 as selectAll,
  ...
  timeHours,
  timeInterval,
  millisecond2 as timeMillisecond,
